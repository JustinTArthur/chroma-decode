...
#ifndef CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_2D_H
#define CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_2D_H
...
public:
    ...
    void filterFields(const std::vector<chd::decoders::SourceField> &inputFields, int32_t startIndex, int32_t endIndex,
                      std::vector<const double *> &outputFields) override;

protected:
    void filterField(const chd::decoders::SourceField& inputField, int32_t outputIndex);
    void forwardFFTTile(int32_t tileX, int32_t tileY, int32_t startY, int32_t endY, const chd::decoders::SourceField &inputField);
    ...
    void overlayFFTFrame(int32_t positionX, int32_t positionY,
                         ...
                         chd::output::ComponentFrame &componentFrame) override;
...
#endif  // CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_2D_H
