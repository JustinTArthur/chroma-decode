...
void TransformPal3D::filterFields(const std::vector<chd::decoders::SourceField> &inputFields, int32_t startIndex, int32_t endIndex,
                                  std::vector<const double *> &outputFields)
{
    ...
    assert((inputFields.size() - endIndex) >= static_cast<size_t>(HALFZTILE));
...
void TransformPal3D::forwardFFTTile(int32_t tileX, int32_t tileY, int32_t tileZ, const std::vector<chd::decoders::SourceField> &inputFields)
{
