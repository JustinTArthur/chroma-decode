...
#ifndef CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_3D_H
#define CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_3D_H
...
public:
    ...
    void filterFields(const std::vector<chd::decoders::SourceField> &inputFields, int32_t startFieldIndex, int32_t endFieldIndex,
...
#endif  // CHD_DECODERS_PALCOLOUR_TRANSFORM_PAL_3D_H
